        ...
        <div className="py-12 md:pt-20 md:pb-16">
          <div className="max-w-3xl mx-auto">
            <div className="text-lg text-slate-500">
              <h2 className="h3 font-quicksand text-slate-800 mb-4">About Black Inc.</h2>
              <p className="mb-8">
                ...
                commodo elit at imperdiet. Semper auctor neque vitae tempus quam pellentesque nec. Amet dictum sit amet justo donec enim diam. Varius sit amet
                mattis vulputate enim nulla aliquet porttitor. Odio pellentesque diam volutpat commodo sed. Elit sed vulputate mi sit amet mauris commodo quis
                imperdiet.
              </p>
              ...
              <h3 className="flex h4 font-quicksand text-slate-800 mb-4 lg:-ml-10">
              ...
              <p className="mb-8">
                Et leo duis ut diam quam nulla porttitor porttitor lacus luctus accumsan tortor, lorem dolor sed viverra ipsum nunc aliquet bibendum enim eu
                augue ut lectus arcu bibendum at. Non sodales neque sodales ut etiam sit. Venenatis urna cursus eget nunc scelerisque viverra mauris in aliquam.
              </p>
              <h3 className="flex h4 font-quicksand text-slate-800 mb-4 lg:-ml-10">
                <div className="mr-5 mt-2">
                  <svg className="fill-blue-600 shrink-0" width="20" height="16">
              ...
              <p className="mb-8">
                A condimentum vitae sapien pellentesque habitant morbi tristique, nunc sed blandit libero volutpat sed cras ornare arcu dui Ullamcorper velit
                sed ullamcorper morbi. Lacus laoreet non curabitur gravida adipiscing bibendum.
              </p>
              <h3 className="flex h4 font-quicksand text-slate-800 mb-4 lg:-ml-10">
                <div className="mr-5 mt-2">
                  <svg className="fill-blue-600 shrink-0" width="20" height="16">
              ...
              <h2 className="h3 font-quicksand text-slate-800 mb-4">Conclusion</h2>
              <p className="mb-8">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis
                scelerisque fermentum. Neque sodales ut etiam sit amet how to manage{" "}
                <a className="font-medium text-green-600 hover:underline" href="#0">
