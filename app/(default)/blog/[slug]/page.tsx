              ...
              <div className="max-w-3xl mx-auto">
                <div className="mb-8">
                  ...
                  <div className="text-center md:text-left">
                    <Link
                      className="inline-flex font-semibold text-green-600 hover:text-green-500 transition duration-150 ease-in-out group mb-2"
                      href="/blog"
                      data-aos="fade-down"
                    >
                  ...
                  <div className="md:flex md:items-center md:justify-between mt-3" data-aos="fade-up">
                    ...
                    <div className="flex justify-center mt-4 md:mt-0">
                      <ul className="flex space-x-5 mb-4 md:order-1 md:ml-4 md:mb-0">
                        <li>
                          <a className="text-green-600 hover:text-green-500 transition duration-150 ease-in-out" href="#0" aria-label="Facebook">
                        ...
                        <li>
                          <a className="text-green-600 hover:text-green-500 transition duration-150 ease-in-out" href="#0" aria-label="Twitter">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                          <a className="text-green-600 hover:text-green-500 transition duration-150 ease-in-out" href="#0" aria-label="Pinterest">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
