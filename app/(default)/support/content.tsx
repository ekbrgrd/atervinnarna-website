            ...
            <article className="bg-white p-6 md:px-8 shadow-lg" data-aos="fade-up" data-aos-anchor="[data-aos-id-support]">
              <div className="flex">
                ...
                <div className="flex items-center shrink-0 pr-6 sm:pr-8 sm:mr-6 sm:border-r border-slate-200">
                  <svg className="w-8 h-8 fill-green-600" viewBox="0 0 32 32">
                ...
                <div className="grow">
                  <header>
                    <h2 className="h4 font-quicksand mb-2">
                      <Link className="text-slate-800 hover:underline hover:decoration-green-100" href="/blog/sa-kommer-du-igang-med-var-atervinningstjanst">
                        Såhär kommer du igång med Återvinnarna
                      </Link>
                    </h2>
                  </header>
                  <p className="text-slate-500 mb-4">Ny till Återvinnarna eller känner du dig lite vilsen? Börja här ;)</p>
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
                      <Image className="rounded-full border-2 border-white box-content" src={AvatarImageMans} width={32} height={32} alt="Avatar 01" />
                    </div>
                    <div className="grow text-sm font-medium text-slate-600">
                      <Link
                        className="text-slate-800 hover:text-green-600 transition duration-150 ease-in-out"
                        href="/blog/sahar-kommer-du-igang-med-var-atervinningstjanst"
                      >
                        Artikel
                      </Link>{" "}
                      skriven av Måns Oxelström
                    </div>
                  </footer>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="grow">
                  <header>
                    <h2 className="h4 font-quicksand mb-2">
                      <Link
                        className="text-slate-800 hover:underline hover:decoration-green-100"
                        href="/blog/sa-fungerar-betalningen-for-var-atervinningstjanst"
                      >
                        Betalning
                      </Link>
                    </h2>
                  </header>
                  <p className="text-slate-500 mb-4">Här kan du läsa kring hur betalning fungerar för vår tjänst.</p>
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
                      <Image className="rounded-full border-2 border-white box-content" src={AvatarImageKilean} width={32} height={32} alt="Avatar 01" />
                    </div>
                    <div className="grow text-sm font-medium text-slate-600">
                      <Link
                        className="text-slate-800 hover:text-green-600 transition duration-150 ease-in-out"
                ...
                <div className="grow">
                  ...
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
                      ...
                      <Image className="rounded-full border-2 border-white box-content" src={AvatarImageMans} width={32} height={32} alt="Avatar 02" />
