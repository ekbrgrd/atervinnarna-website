        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          <div className="px-5 sm:px-6 py-8">
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="mb-6">
                {/* Logo */}
                <Link className="inline-flex text-green-600 transition duration-150 ease-in-out" href="/" aria-label="Cruip">
              ...
              <h1 className="h2 font-quicksand text-slate-800 mb-12">Request your demo</h1>
