      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="mt-12 md:mt-16">
          <div className="relative flex flex-col lg:flex-row justify-between items-center bg-white shadow-lg p-6">
            ...
            <div className="h4 font-quicksand text-center lg:text-left mb-4 lg:mb-0 lg:text-base">Kampanj! Just nu är startavgiften 0 kr, och om du registrerar dig innan jul hämtar vi din julgran!</div>
