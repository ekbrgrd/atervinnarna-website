      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-quicksand text-slate-800">What do we value? All sorts of things!</h2>
          </div>
          ...
          >
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]">
              ...
              <h4 className="h4 font-quicksand text-slate-800 mb-2">Mark Lamprecht</h4>
              <div className="font-medium text-green-600">CEO &amp; Co-founder</div>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={100}>
              ...
              <h4 className="h4 font-quicksand text-slate-800 mb-2">Elisa Nguyen</h4>
              <div className="font-medium text-green-600">Co-Founder, Lead Engineer</div>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={200}>
              ...
              <h4 className="h4 font-quicksand text-slate-800 mb-2">Travis Stephens</h4>
              <div className="font-medium text-green-600">Senior Software Engineer</div>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={300}>
              ...
              <h4 className="h4 font-quicksand text-slate-800 mb-2">Cameron Mckay</h4>
              <div className="font-medium text-green-600">Senior UX/UI Designer</div>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={400}>
              ...
              <h4 className="h4 font-quicksand text-slate-800 mb-2">Patricia Curnock</h4>
              <div className="font-medium text-green-600">Software Engineer</div>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={500}>
              ...
              <h4 className="h4 font-quicksand text-slate-800 mb-2">Amanda Danish</h4>
              <div className="font-medium text-green-600">Business Development</div>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={600}>
              ...
              <h4 className="h4 font-quicksand text-slate-800 mb-2">Zoltan Jackson</h4>
              <div className="font-medium text-green-600">Marketing Manager</div>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={700}>
              ...
              <h4 className="h4 font-quicksand text-slate-800 mb-2">Sara Tolinski</h4>
              <div className="font-medium text-green-600">Community Manager</div>
            </div>
          </div>
        </div>
      </div>
