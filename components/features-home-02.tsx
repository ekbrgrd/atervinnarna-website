      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-quicksand text-slate-800">The quick brown fox jumped over the lazy dog</h2>
          </div>
          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-start md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
            ...
            <div className="md:w-7/12 lg:w-1/2" data-aos="fade-up">
              <div className="mb-8 text-center md:text-left">
                <h3 className="h3 text-slate-800 font-quicksand mb-3">Built exclusively for you</h3>
              ...
              <div className="mb-8 md:mb-0">
                <button
                  className={`flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3 ${
                    tab !== 1 ? "border-transparent opacity-50 hover:opacity-75" : "border-2 border-blue-500 opacity-100"
                  }`}
                  onClick={(e) => {
                    e.preventDefault();
                    setTab(1);
                ...
                >
                  <svg className="w-4 h-4 fill-current text-green-600 shrink-0 mt-1 mr-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <button
                  className={`flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3 ${
                    tab !== 2 ? "border-transparent opacity-50 hover:opacity-75" : "border-2 border-blue-500 opacity-100"
                  }`}
                  onClick={(e) => {
                    e.preventDefault();
                    setTab(2);
                ...
                <button
                  className={`flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3 ${
                    tab !== 3 ? "border-transparent opacity-50 hover:opacity-75" : "border-2 border-blue-500 opacity-100"
                  }`}
                  onClick={(e) => {
                    e.preventDefault();
                    setTab(3);
